...
msbuild /r /p:Configuration=Release /p:Platform=AnyCPU $BUILD_SOURCESDIRECTORY/src/SamplesApp/SamplesApp.iOS/SamplesApp.iOS.csproj
msbuild /r /p:Configuration=Release /p:Platform=AnyCPU $BUILD_SOURCESDIRECTORY/src/SamplesApp/SamplesApp.UITests/SamplesApp.UITests.csproj
